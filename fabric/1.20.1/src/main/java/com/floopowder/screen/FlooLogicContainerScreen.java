...
/**
 * Fabric 1.20.1 container screen that delegates to IFlooContainerScreenLogic.
 */
public class FlooLogicContainerScreen<T extends AbstractContainerMenu> extends AbstractContainerScreen<T> {
  ...
  public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
    // 1.20.1 uses 1-param renderBackground
  ...
  public boolean mouseScrolled(double mouseX, double mouseY, double delta) {
    // Fabric 1.20.1 uses 3-param mouseScrolled, delta is the vertical scroll
