...
/**
 * Fabric 1.18.2 implementation of IFlooContainerScreenContext.
...
public class FlooContainerScreenContext<T extends AbstractContainerMenu> implements IFlooContainerScreenContext<T> {
  ...
  public void addRenderableWidget(Object widget) {
    if (widget instanceof GuiEventListener && widget instanceof Widget && widget instanceof NarratableEntry) {
      screen.addRenderableWidget((GuiEventListener & Widget & NarratableEntry) widget);
    }
  }
  ...
  public void addRenderableOnly(Object renderable) {
    if (renderable instanceof Widget) {
      screen.addRenderableOnly((Widget) renderable);
    }
  }
